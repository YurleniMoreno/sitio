      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="" class="nav-link">Bienvedid@ Yurleni</a></li>
            
			<li class="nav-item"><a href="index.php"><i id="conf" class='bx bx-cog' class="nav-link">Cerrar sesion</i></a></li>
